...
public class BanjixinxiController {
    ...
    public R info(@PathVariable("id") Long id){
		...
		banjixinxi.setClicknum(banjixinxi.getClicknum()+1);
		banjixinxi.setClicktime(new Date());
    ...
    public R autoSort(@RequestParam Map<String, Object> params,BanjixinxiEntity banjixinxi, HttpServletRequest request,String pre){
        EntityWrapper<BanjixinxiEntity> ew = new EntityWrapper<BanjixinxiEntity>();
